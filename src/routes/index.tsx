...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Balo English Medium School Medium School — Free Education for Every Child in Howrah" },
      { name: "description", content: "Balo English Medium School Medium School is a community NGO in Salkia, Howrah delivering free English-medium education to underprivileged children since inception. Join us." },
      { property: "og:title", content: "Balo English Medium School Medium School — Educating Howrah's Brightest Futures" },
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        "@type": "School",
        name: "Balo English Medium School Medium School",
  ...
  return (
    <section ref={ref} id="top" className="relative min-h-screen flex items-center overflow-hidden pt-24">
      <motion.div style={{ y, scale }} className="absolute inset-0 -z-10">
        <img src={hero} alt="Children at Balo English Medium School Medium School" className="size-full object-cover" width={1600} height={1024} />
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center w-full">
        <div className="lg:col-span-7 text-white">
          ...
          <motion.p initial="hidden" animate="show" variants={fadeUp} custom={2} className="mt-6 text-lg md:text-xl text-white/85 max-w-xl">
            Balo English Medium School Medium School is a community-run NGO delivering free, quality English-medium education to the children of Babudanga, Pilkhana — one classroom, one bright future at a time.
          </motion.p>
    ...
    <section id="contact" className="py-28 px-6 bg-card">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.7 }}
          ...
          <iframe
            title="Balo English Medium School Medium School location"
