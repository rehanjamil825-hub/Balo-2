...
export const Route = createFileRoute("/extracurricular")({
  head: () => ({
    meta: [
      { title: "Extracurricular Activities — Balo English Medium School Medium School, Howrah" },
      { name: "description", content: "Discover sports day, summer camp, rugby, and fun fiesta at Balo English Medium School Medium School — where learning extends beyond the classroom." },
      { property: "og:title", content: "Extracurricular Activities — Balo English Medium School Medium School" },
      { property: "og:description", content: "Sports day, summer camp, rugby, and fun fiesta at Balo English Medium School Medium School, Howrah." },
  ...
  return (
    <section ref={ref} className="relative min-h-[70vh] flex items-center overflow-hidden pt-24">
      <motion.div style={{ y, scale }} className="absolute inset-0 -z-10">
        <img
          src={hero}
          alt="Children playing at Balo English Medium School Medium School"
      ...
      <div className="max-w-7xl mx-auto px-6 w-full text-white">
        <motion.div initial="hidden" animate="show" variants={fadeUp}>
          ...
          <p className="mt-6 text-lg md:text-xl text-white/85 max-w-2xl">
            At Balo English Medium School Medium School, sports, camps, and celebrations are part of the curriculum. We believe happy, active children become confident, well-rounded adults.
          </p>
        </motion.div>
      </div>
    </section>
    ...
    <section className="py-28 px-6 bg-card">
      ...
      >
        ...
        <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
          Enrol your child at Balo English Medium School Medium School and give them access to academics, sports, arts, and community life — all free of cost.
        </p>
        <a
          href="/#contact"
