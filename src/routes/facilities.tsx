...
export const Route = createFileRoute("/facilities")({
  head: () => ({
    meta: [
      { title: "Facilities — Balo English School, Howrah" },
      { name: "description", content: "Explore Balo English School's modern facilities: library, computer lab, science laboratory, smart classes, and air-conditioned classrooms." },
      { property: "og:title", content: "Facilities — Balo English School" },
      { property: "og:description", content: "Library, computer lab, science laboratory, smart classes, and AC classrooms at Balo English School, Howrah." },
  ...
  return (
    <section ref={ref} className="relative min-h-[70vh] flex items-center overflow-hidden pt-24">
      <motion.div style={{ y, scale }} className="absolute inset-0 -z-10">
        <img
          src={hero}
          alt="Balo English School classroom"
      ...
      <div className="max-w-7xl mx-auto px-6 w-full text-white">
        <motion.div initial="hidden" animate="show" variants={fadeUp}>
          ...
          <p className="mt-6 text-lg md:text-xl text-white/85 max-w-2xl">
            From a cozy library to air-conditioned smart classrooms, every corner of Balo English School is built to help children learn with comfort, curiosity, and confidence.
          </p>
        </motion.div>
      </div>
    </section>
  ...
  return (
    <section className="py-28 px-6 gradient-warm">
      ...
      >
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          Families are welcome to visit Balo English School and experience our facilities firsthand.
        </p>
        <a
          href="/#contact"
